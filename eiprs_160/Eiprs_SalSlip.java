...
class Eiprs_SalSlipApp implements ActionListener
{
	...
	Statement stmtInsert,stmtSelect,stmtData,stmtSearch,stmtDelete,stmtUpate,stmtDupSlipNo,stmtfillSID;
...
//Constructor Begin
	...
	public void actionPerformed(ActionEvent ae)
	{
		...
		//String Name --> TextField.getText();
			...
			try
			{
				stmtUpate=conn.createStatement();
