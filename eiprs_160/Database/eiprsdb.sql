...
insert  into `eiprs_tbllogin`(`User_Name`,`Passwords`,`Password_Hint`,`Hint_Answer`) values ('1234','0000','Your Favourite Person','bgu'),('Bigyanshu','BSBJ@4O','Your Favourite Person','First Name Of Your Omnipotent'),('4444','4444','Your Favourite Person','Same Number');
